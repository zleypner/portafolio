...
const experiences = [
  {
    ...
    description: [
      'Contributed to enterprise-scale platforms using React and Angular, supporting internal and client-facing business applications.',
      'Built and maintained user interfaces with Next.js (SSR/SSG) and Angular, focusing on performance, usability, and consistency across the platform.',
      'Integrated frontend applications with REST APIs built in .NET, supporting core workflows within an enterprise environment.',
      'Worked with SQL Server and PostgreSQL databases, writing and optimizing queries to support enterprise data models and reporting needs.',
      'Assisted in maintaining and improving existing .NET services, fixing bugs and delivering incremental enhancements.',
      'Participated in implementing automated testing (unit, integration, E2E) to improve reliability of enterprise applications.',
      'Supported containerized development and deployments using Docker and GitHub Actions.',
      'Collaborated with cross-functional teams through code reviews and shared debugging in a large-scale enterprise codebase.',
    ],
    techStack: ['React', 'Angular', 'Next.js', '.NET', 'SQL Server', 'PostgreSQL', 'Docker', 'GitHub Actions'],
  },
  {
    date: '2020 — 2022',
